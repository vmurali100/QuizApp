...
var quiz = new Quiz(questions); // This is line which is Going to be Excuted First . Step 1 .
// with prototype we have added 3 methods , isEnded, guess ,getQuestionIndex();
console.log(quiz)
populate(); // Will display all the Questions
